...
<div class="row">
    <div class="col-md-5">
        <ul class="list-group">
            ...
            <label for="result_price">total price</label>
    ...
    <div class="col-md-5">
        <c:if test="${sessionScope.user_role='PATIENT' or sessionScope.user_role='GUEST'}">
            <a href="/pharmacy?command=add_order&order_patient=${sessionScope.user_id}">
                <button type="button" class="btn btn-success inline">Buy</button>
            </a>
        </c:if>
    </div>
</div>
